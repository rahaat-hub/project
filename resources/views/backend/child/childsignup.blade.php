...
<form method="POST" class="form-horizontal" action="{{route('child.store')}} " role="form">
  {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="f_name" name="f_name" value="{{old('f_name')}}" placeholder="Father Name" class="form-control" autofocus>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="m_name" name="m_name" value="{{old('m_name')}}" placeholder="Mother's Name" class="form-control" autofocus>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="email" id="email" name="email" value="{{old('email')}}" placeholder="Email" class="form-control" name="email" autofocus>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirm Password" class="form-control" autofocus>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="date" name="birthDate" value="{{old('birthDate')}}" id="birthDate" class="form-control" autofocus>
            </div>
        </div>
        <div class="form-group">
            <label for="phoneNumber" class="col-sm-3 control-label">Phone number* </label>
            <div class="col-sm-9">
                <input type="phoneNumber" name="phoneNumber" id="phoneNumber" value="{{old('phoneNumber')}}" placeholder="Phone number" class="form-control" autofocus>
                @error('phoneNumber')  <p class="text-danger">{{ $message }}</p> @enderror
                <span class="help-block">Your phone number won't be disclosed anywhere </span>
            </div>
        </div class="form-group">
            <label for="address" class="col-sm-3 control-label" >Address*</label>
            <input type="text-area" name="address" id="address" value="{{old('address')}}" placeholder="address" class="form-control" autofocus>
