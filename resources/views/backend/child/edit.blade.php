        ...
        <div class="form">
            ...
            <div class="form-content">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="Email" name="email" class="form-control" value="{{$ch->email}}" placeholder="Your Email *" />
                            
                        </div>
                        <div class="form-group">
                            <input type="password" name="password" class="form-control" value="{{$ch->password}}" placeholder="Your Password *" />
                    ...
                    <div class="form-row">
                        <div class="col-md-4">
                            ...
                            <select id="blood_group" name="blood_group" value="{{$ch->name}}" class="form-control">
